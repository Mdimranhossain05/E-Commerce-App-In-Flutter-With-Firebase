...
class _UserDataScreenState extends State<UserDataScreen> {
  ...
  sendUserDataToDB()async{
    ...
    }).then((value) => Navigator.push(context, MaterialPageRoute(builder: (_)=>BottomNavBar()))).catchError((error)=>Fluttertoast.showToast(msg: "something is wrong. $error"));
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // elevated button
                CustomButtton("Continue", (){sendUserDataToDB();}),
              ],
            ),
          ),
        ),
